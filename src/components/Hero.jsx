        ...
        <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2">
                <div className="flex flex-col items-center lg:items-start">
                    ...
                    initial="hidden"
                    animate="visible"  
                    className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl">Sivateja Diddekunta</motion.h1>
                    <motion.span
                    ...
                    text-transparent">Data Engineer & Analytics Specialist</motion.span>
                    <motion.p  
